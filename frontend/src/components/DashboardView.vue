  ...
  >
    ...
    >
      ...
      <div
        ...
        class="flex items-center gap-3 px-3 py-2 rounded bg-[var(--color-surface-header)] border border-[var(--color-outline-variant)]/60"
      >
        ...
        <div class="flex flex-col">
          <span
            class="text-[10px] font-semibold font-mono tracking-wider text-[var(--color-mono-text)] uppercase"
            >引擎平台</span
          >
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
      <div
        id="metric-gateway"
        class="p-5 rounded border border-[var(--color-outline-variant)]/60 bg-[var(--color-surface-header)]/40 flex items-center gap-4"
      >
        <div
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      >
        ...
        <a-button
          block
          size="middle"
          class="block-btn action-btn mt-6"
    ...
    <div
      class="rounded border border-[var(--color-outline-variant)] bg-[var(--color-surface)] p-6 shadow-xl relative overflow-hidden"
    >
      ...
      <form @submit.prevent="handleQuickSend" class="space-y-4">
        ...
        <div class="flex items-center justify-between">
          <span class="text-[10px] text-[var(--color-mono-text)]/55 font-mono"
